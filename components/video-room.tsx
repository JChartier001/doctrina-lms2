...
import { Mic, MicOff, Video, VideoOff, ScreenShare, PhoneOff, MessageSquare, Users } from "lucide-react"
...
export function VideoRoom({ sessionId, userId, userName, userImage, isHost, onLeave }: VideoRoomProps) {
  ...
  const toggleScreenShare = () => {
    ...
    toast({
      title: isScreenSharing ? "Stopped sharing screen" : "Started sharing screen",
      duration: 2000,
    })
  }
  ...
  const toggleRecording = () => {
    if (isHost) {
      ...
      toast({
        title: "Only the host can record the session",
        variant: "destructive",
        duration: 2000,
      })
    }

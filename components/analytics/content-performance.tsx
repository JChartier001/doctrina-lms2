...
const lessonCompletionData = [
  { name: "Introduction to Botox", views: 78, completions: 75, avgTimeMinutes: 12, satisfaction: 4.8 },
  { name: "Facial Anatomy Basics", views: 76, completions: 72, avgTimeMinutes: 28, satisfaction: 4.6 },
  { name: "Injection Techniques", views: 74, completions: 68, avgTimeMinutes: 35, satisfaction: 4.9 },
  { name: "Managing Complications", views: 70, completions: 62, avgTimeMinutes: 25, satisfaction: 4.7 },
  { name: "Advanced Applications", views: 65, completions: 55, avgTimeMinutes: 30, satisfaction: 4.5 },
  { name: "Case Studies", views: 60, completions: 48, avgTimeMinutes: 40, satisfaction: 4.8 },
  { name: "Business Practices", views: 55, completions: 42, avgTimeMinutes: 22, satisfaction: 4.4 },
]

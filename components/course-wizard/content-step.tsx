...
import { Video, FileText, ListChecks, Upload, Plus, Trash2, Sparkles } from "lucide-react"
                      ...
                      <div className="space-y-1">
                        {section.lessons.map((lesson) => (
                          <Button
                            ...
                            onClick={() =>
                              handleLessonSelect({ ...lesson, sectionId: section.id, sectionTitle: section.title })
                            }
                          >
          ...
          {selectedLesson ? (
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-muted-foreground">Section: {(selectedLesson as any).sectionTitle}</p>
              </CardHeader>
              <CardContent>

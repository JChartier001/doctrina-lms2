...
export function StructureStep({
	...
	const deleteSection = (sectionId: string) => {
		const updatedSections = courseData.sections.filter(
		...
		if (selectedSectionId === sectionId) {
			setSelectedSectionId(
				updatedSections.length > 0 ? updatedSections[0].id : null
			);
		}
	};
		...
		<div className='space-y-6'>
			<div>
				...
				<p className='text-muted-foreground mb-6'>
					Organize your course into sections and lessons. Drag and drop to
					reorder.
				</p>
			</div>
											...
											{courseData.sections.length === 0 ? (
												<div className='text-center py-8 border-2 border-dashed rounded-lg'>
													<p className='text-muted-foreground'>
														No sections yet. Add your first section to get
														started.
													</p>
												</div>
											) : (
																		...
																		<div className='flex items-end gap-2'>
																			...
																			<div className='space-y-1'>
																				...
																				<Select
																					value={newLessonType}
																					onValueChange={(
																						value: 'video' | 'document' | 'quiz'
																					) => setNewLessonType(value)}
																				>
																					<SelectTrigger
																						id={`lessonType-${section.id}`}
																						className='w-28'
																					>
																						<SelectValue />
																					</SelectTrigger>

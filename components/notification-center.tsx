...
import { type Notification, useMarkAllAsRead, useMarkAsRead, useUserNotifications } from '@/lib/notification-service';
...
export function NotificationCenter() {
	...
	const notifications = useUserNotifications(user?.id as Id<'users'>);

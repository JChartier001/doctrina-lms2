# Continuing Education (CE) Credits Policy
...
## For Students: Understanding CE Credits on Doctrina LMS

### What You Need to Know

**Doctrina LMS is an education marketplace, NOT an accredited continuing education provider.**
...
- Act as a CE provider or accrediting body

---

### How CE Credits Work on Doctrina LMS
...
1. Apply for CE provider approval from an accrediting body:
   ...
   - **State Nursing Boards** - state-specific CE approval for nurses and nurse practitioners
   - **State Esthetics Boards** - for licensed estheticians (varies by state)
   - **State Medical Boards** - for physicians and physician assistants
   - **Professional associations** - specialty-specific CE approval
   - **Other recognized accrediting organizations**

2. Get their specific course(s) approved by that accrediting body
3. Receive a CE provider number and approval documentation
4. Submit proof of accreditation to Doctrina LMS
...
- Display the CE provider number
...
✅ 6.0 CE Credits Available
   Accreditation: ANCC Provider #P123456
   Valid through: December 31, 2026
```

#### Step 3: You Verify CE Credits Will Work for Your License
...
4. Confirm the course topic qualifies toward your requirements
...
- Do I need to keep certificates for audit purposes?
- Are there specific CE requirements for medical aesthetics procedures?

**We Cannot Answer These Questions for You**
Every state has different requirements. What counts for license renewal in California may not count in Texas. We provide the course information; YOU are responsible for verifying it meets YOUR needs.
...
- **Physicians (MD/DO):** Check state medical board and specialty board requirements
- **Licensed Estheticians:** Check your state's Board of Cosmetology or Esthetics Board

#### Q: What if I take a course for CE credits and my board rejects it?

**A:** This is why verification before enrollment is critical. Doctrina LMS is not responsible if CE credits are rejected by your board. We display instructor-provided CE information accurately, but cannot guarantee acceptance by every licensing board.

Some courses may be accepted in certain states but not others. Always verify first.
...
- Accrediting body and provider number
- Date of completion
- Instructor's signature or digital signature

Keep this certificate for your license renewal records. Some states audit CE compliance.

#### Q: Do ALL courses on Doctrina LMS offer CE credits?

**A:** No. Only courses where the instructor has obtained CE accreditation will offer CE credits. Many excellent courses on Doctrina LMS do NOT offer CE credits but still provide valuable skills and knowledge for career development.

You can filter courses to show only those offering CE credits if that's important to you.
...
- Advanced techniques beyond basic certification (lasers, PDO threads, etc.)
- Non-clinical skills (patient consultations, photography, social media)
...
- Approved CE providers for your state

Some instructors on Doctrina LMS may have state esthetics board approval for their courses.

#### Q: If I have questions about whether CE credits will work for my license, who do I ask?
...
- **Estheticians:** Search "[Your State] Board of Cosmetology" or "Esthetics Board"
- **Other professions:** Search for your profession's licensing board in your state

---

### Your Responsibilities as a Student

When enrolling in courses offering CE credits, you acknowledge and agree to:

✅ Verify CE credit acceptance with your licensing board BEFORE enrolling
✅ Keep all CE certificates for your records (audit protection)
✅ Report CE credits to your licensing board according to their requirements
✅ Understand that Doctrina LMS is a marketplace, not a CE provider
✅ Accept that the instructor, not Doctrina LMS, is responsible for CE accreditation

---

## For Instructors: Offering CE Credits on Your Courses

### Can You Offer CE Credits?

**YES** - If you obtain your own CE provider approval from an accrediting body

**NO** - Doctrina LMS platform does not provide or facilitate CE accreditation for you

### How to Offer CE Credits for Your Courses

#### Step 1: Become an Approved CE Provider
...
- **ANCC** (American Nurses Credentialing Center): https://www.nursingworld.org/ancc/
  ...
  - Costs vary ($500-$3,000 depending on program)
  - Requires organizational structure and quality processes

- **State Nursing Boards**: Many states offer CE provider approval
  - Example: California Board of Registered Nursing (CEP number)
  - Generally faster and cheaper than national accreditation
...
- **State Cosmetology or Esthetics Boards**: Apply for CE provider approval
  ...
  - Costs typically lower than medical CE ($100-$500)
...
4. Pay course approval fees (if applicable)
5. Receive approval number for that specific course
...
- **CE Credit Hours** (as approved by accrediting body)
- **Approval Documentation** (approval letter, certificate, or screenshot)
...
- **Keep records** for audits (usually 4-6 years)
- **Notify Doctrina LMS** if CE approval expires or is revoked

---

### Instructor Requirements for CE Courses

If you offer CE credits, you MUST:

✅ **Have legitimate CE provider approval** - No fake or expired approvals
✅ **Provide accurate CE information** - Credit hours, accrediting body, provider number
✅ **Issue proper CE certificates** - Include all required information
✅ **Maintain compliance** - Follow accrediting body requirements
✅ **Update Doctrina LMS** - Notify us of any changes to CE status
✅ **Indemnify platform** - You're responsible for CE compliance, not Doctrina LMS
...
- You will comply with all accrediting body requirements
- You will indemnify Doctrina LMS from any CE-related claims
...
- Report to accrediting body if required
...
4. Accrediting body name (e.g., "ANCC Provider #P123456")
5. Your name and credentials
6. Date of completion
7. Certificate unique ID or number (for verification)
...
Doctrina LMS provides a CE certificate template generator in your Instructor Dashboard. Customize with your CE provider information.
...
- **State Esthetics Boards:** $100-$500 application + $50-$200 annual
- **Course Approvals:** $0-$500 per course (varies)
...
Start with state board approval for your primary state. Expand to national accreditation if teaching students nationwide.

#### Q: Can I offer CE credits on Doctrina LMS if I'm already a CE provider elsewhere?

**A:** Yes! If you have CE provider approval (from teaching at a hospital, medical spa, university, or another platform), you can offer those same approved courses on Doctrina LMS. Just submit your existing CE approval documentation.

#### Q: What if my CE approval expires?

**A:** You must notify Doctrina LMS immediately. We will remove the "CE Credits Available" badge from your course until you submit proof of renewal. Students who completed the course before expiration still receive CE certificates with the approval that was valid at the time.
...
- Independent CE accreditation companies

The CE provider approves your course and issues certificates. You split CE fees with them (typically 20-40%). Submit their approval documentation to Doctrina LMS.

#### Q: Do I have to offer CE credits on my courses?
...
- Non-licensed aesthetic services (for estheticians)
...
4. Confirm credit hours are accurate
...
- Issue CE certificates for non-approved courses
...
Doctrina LMS makes no representations or warranties that CE credits offered by instructors will be accepted by any state licensing board, professional organization, or employer. Students are solely responsible for verifying CE requirements with their licensing authority.

**INSTRUCTOR RESPONSIBILITY:**
All CE accreditation is provided by individual instructors or their CE provider partners, NOT by Doctrina LMS platform. Instructors are solely responsible for obtaining CE approval, maintaining compliance, and issuing valid CE certificates.

**PLATFORM ROLE:**
Doctrina LMS's role is limited to displaying instructor-provided CE information and facilitating certificate generation. We verify CE provider numbers when possible but are not the source of CE accreditation.

**NO LEGAL ADVICE:**
Nothing in this policy constitutes legal advice regarding CE requirements, licensing compliance, or state regulations. Consult your licensing board or an attorney for guidance on CE obligations.

---

## Changes to This Policy

Doctrina LMS reserves the right to modify this CE Credits Policy at any time. Material changes will be communicated to instructors offering CE credits with 30 days notice.

**Current Version:** 1.0
**Effective Date:** [Platform Launch]
**Last Updated:** January 2025
...
- **ACPE (Pharmacists):** https://www.acpe-accredit.org/
- **State Nursing Boards:** https://www.ncsbn.org/contactbon.htm

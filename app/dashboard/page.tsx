...
import { CalendarIcon, GraduationCapIcon, UsersIcon, BookOpenIcon, BarChart2 } from "@/components/icons"
        ...
        <TabsContent value="overview" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">5 new discussions today</p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            ...
            <Card className="col-span-3">
              ...
              <CardContent>
                <div className="space-y-4">
                  {["Facial Anatomy Masterclass", "Business Management for Aesthetics", "Advanced Dermal Fillers"].map(
                    (course, i) => (
                      <div key={i} className="flex items-center">
                        <div className="mr-4 h-9 w-9 rounded-full bg-primary/10 flex items-center justify-center">
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-sm text-muted-foreground">
                            {["Beginner", "Intermediate", "Advanced"][i]} · {[4, 6, 8][i]} hours
                          </p>
                        </div>
                      </div>
                    ),
            ...
            {[
              ...
              <Card key={i}>
                <CardHeader>
                  ...
                  <CardDescription>
                    {["Beginner", "Advanced", "Intermediate"][i]} · {[10, 15, 12][i]} hours
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-2">
                    ...
                    <div className="h-2 bg-secondary rounded-full overflow-hidden">
                      <div className="h-full bg-primary" style={{ width: `${[75, 45, 90][i]}%` }} />
                    </div>

...
const courseData = {
	...
	lessons: [
		...
		},
		{
			...
			completed: true,
			content:
				'This lesson covers facial anatomy relevant to Botox injections.',
		},
		{
			id: '3',
			...
			completed: true,
			content:
				'Learn about different injection techniques for various facial areas.',
		},
		{
			id: '4',
			title: 'Case Studies',
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>
								...
								{courseData.lessons.filter(l => l.completed).length} completed
							</CardDescription>
						</CardHeader>
						<CardContent>

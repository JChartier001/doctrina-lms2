  ...
  curriculum: [
    ...
    },
    {
      ...
      lessons: [
        ...
        { title: "Upper Face Injection Techniques", duration: "2 hrs", type: "video" },
        { title: "Lower Face Applications", duration: "1.5 hrs", type: "video" },
        { title: "Live Demonstration", duration: "2 hrs", type: "workshop" },
        { title: "Neurotoxin Complications", duration: "1 hr", type: "video" },
        { title: "Neurotoxins Assessment", duration: "45 min", type: "assignment" },
      ],
    },
    {
      title: "Dermal Fillers Comprehensive",
      lessons: [
        { title: "Filler Materials and Properties", duration: "1 hr", type: "video" },
        { title: "Injection Techniques and Planes", duration: "1.5 hrs", type: "video" },
        { title: "Midface and Cheek Augmentation", duration: "2 hrs", type: "video" },
        { title: "Lip Enhancement Masterclass", duration: "2 hrs", type: "video" },
        { title: "Jawline and Chin Contouring", duration: "1.5 hrs", type: "video" },
        { title: "Live Demonstration", duration: "2 hrs", type: "workshop" },
        { title: "Fillers Final Assessment", duration: "1 hr", type: "assignment" },
      ],
    },
  ],
  reviews: [
          ...
          <Card className="sticky top-20">
            ...
            <CardContent className="space-y-4">
              <RadioGroup value={selectedPricing} onValueChange={setSelectedPricing} className="space-y-3">
                ...
                <div className="flex items-center space-x-2 rounded-md border p-3 cursor-pointer hover:bg-accent relative overflow-hidden">
                  <RadioGroupItem value="yearly" id="yearly" />
                  <Label htmlFor="yearly" className="flex flex-1 justify-between cursor-pointer">
                    <span>Annual</span>
                    <div>

...
const programs = [
	...
	},
	{
		...
		description:
			'Explore the science and application of various energy-based devices used in medical aesthetics.',
		image: '/placeholder.svg?height=250&width=500',
		duration: '4 months',
		courses: 4,
		students: 189,
		...
		<div className='container py-10'>
			<div className='text-center mb-10'>
				...
				<p className='text-xl text-muted-foreground'>
					Comprehensive curricula designed for medical professionals
				</p>
			</div>
			...
			{filteredPrograms.length === 0 ? (
				...
				<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
					{filteredPrograms.map(program => (
						<Card
							key={program.id}
							className={program.featured ? 'border-primary' : ''}
						>
							{program.featured && (

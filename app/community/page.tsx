...
const studyGroups = [
	{
		...
		members: 24,
		description: 'A group focused on mastering advanced injection techniques for aesthetic treatments.',
	...
	},
	{
		...
		members: 18,
		description: 'Discussions on running a successful aesthetic practice, from marketing to patient retention.',
		image: '/placeholder.svg?height=100&width=100',
	},
	{
		id: '3',
		...
		members: 32,
		description: 'Sharing experiences and protocols for managing and preventing treatment complications.',
		image: '/placeholder.svg?height=100&width=100',
	},
];
		...
		<div className="container py-10">
			<div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
				<div>
					...
					<p className="text-muted-foreground">Connect with other medical professionals in the field</p>
				</div>
				...
				<div className="md:w-1/3 space-y-6">
					<Card>
						<CardHeader>
							...
							<CardDescription>Join groups to collaborate with peers</CardDescription>
						</CardHeader>
							...
							{studyGroups.map(group => (
								<div key={group.id} className="flex gap-3 items-start">
									...
									<div className="flex-1">
										...
										<Button variant="outline" size="sm" className="mt-2" onClick={() => handleJoinGroup(group.id)}>
											Join Group
										</Button>
									</div>
								</div>

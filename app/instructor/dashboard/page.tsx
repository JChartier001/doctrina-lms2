					...
					<div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
						<Card className='md:col-span-2'>
							<CardHeader>
								...
								<CardDescription>
									Your course activity from the past 30 days
								</CardDescription>
							</CardHeader>
							<CardContent>
								...
								<Card>
									<CardContent className='p-0'>
										...
										<div className='p-6'>
											...
											<p className='text-sm text-muted-foreground mb-4'>
												Master the art of Botox injections with advanced
												techniques for facial aesthetics.
											</p>
											<div className='flex justify-between text-sm mb-4'>
											...
											<div className='flex gap-2'>
												<Button
													...
													className='flex-1'
													onClick={() =>
														router.push('/instructor/courses/1/edit')
													}
												>
													Edit
												</Button>
												<Button
													className='flex-1'
													onClick={() =>
														router.push('/instructor/courses/1/analytics')
													}
												>
													Analytics
												</Button>
								...
								<Card>
									<CardContent className='p-0'>
										...
										<div className='p-6'>
											...
											<p className='text-sm text-muted-foreground mb-4'>
												Comprehensive training on dermal fillers for facial
											...
											<div className='flex gap-2'>
												<Button
													...
													className='flex-1'
													onClick={() =>
														router.push('/instructor/courses/2/edit')
													}
												>
													Edit
												</Button>
												<Button
													className='flex-1'
													onClick={() =>
														router.push('/instructor/courses/2/analytics')
													}
												>
													Analytics
												</Button>
								...
								<Card>
									<CardContent className='p-0'>
										...
										<div className='p-6'>
											...
											<p className='text-sm text-muted-foreground mb-4'>
												Essential facial anatomy knowledge for safe and
											...
											<div className='flex gap-2'>
												...
												<Button
													className='flex-1'
													onClick={() =>
														router.push('/instructor/courses/3/preview')
													}
												>
													Preview
												</Button>

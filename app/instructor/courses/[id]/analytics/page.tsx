		...
		<div className='container py-10'>
			...
			<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8'>
				<Card>
					...
					<CardContent>
						<div className='text-3xl font-bold'>
							{instructorAnalytics?.overview.totalStudents || 0}
						</div>
						<div className='text-xs text-green-500 flex items-center mt-1'>
							{instructorAnalytics?.overview.totalRevenue
								? '+Active enrollments'
								: 'No enrollments yet'}
						</div>
					</CardContent>
				...
				<Card>
					...
					<CardContent>
						<div className='text-3xl font-bold'>
							{course.rating ? `${course.rating.toFixed(1)}/5.0` : 'N/A'}
						</div>
						<div className='text-xs text-green-500 flex items-center mt-1'>
							{course.reviewCount
				...
				<Card>
					...
					<CardContent>
						<div className='text-3xl font-bold'>
							${instructorAnalytics?.overview.totalRevenue || 0}
						</div>
						<div className='text-xs text-green-500 flex items-center mt-1'>
							From all courses
						</div>
					...
					<div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Breakdown of student backgrounds
								</CardDescription>
							</CardHeader>

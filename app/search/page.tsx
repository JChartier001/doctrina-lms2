...
export default function SearchPage() {
	...
	const searchResult = useUnifiedSearch(
		searchQuery,
		50,
						...
						<Sheet>
							...
							<SheetContent>
								<SheetHeader>
									...
									<SheetDescription>
										Narrow down your search results by content type.
									</SheetDescription>
								</SheetHeader>
								<div className='py-4'>
							...
							>
								<TabsList className='mb-6'>
									...
									<TabsTrigger value='course'>
										Courses ({resultCounts.course || 0})
									</TabsTrigger>
									<TabsTrigger value='program'>
										Programs ({resultCounts.program || 0})
									</TabsTrigger>
									<TabsTrigger value='instructor'>
										Instructors ({resultCounts.instructor || 0})
									</TabsTrigger>
									<TabsTrigger value='community'>
										Community ({resultCounts.community || 0})
									</TabsTrigger>
									<TabsTrigger value='lesson'>
										Lessons ({resultCounts.lesson || 0})
									</TabsTrigger>
								</TabsList>
				...
				<div className='py-12'>
					<div className='max-w-3xl mx-auto'>
						<h2 className='text-2xl font-bold mb-4'>
							Search for courses, programs, and more
						</h2>
						...
						<div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
							<Card className='text-center'>
								<CardContent className='p-6'>
									...
									<p className='text-sm text-muted-foreground'>
										Find individual courses on specific topics
									</p>
								</CardContent>
							</Card>
							...
							<Card className='text-center'>
								<CardContent className='p-6'>
									...
									<p className='text-sm text-muted-foreground'>
										Explore comprehensive educational programs
									</p>
								</CardContent>
							</Card>
							...
							<Card className='text-center'>
								<CardContent className='p-6'>
									...
									<p className='text-sm text-muted-foreground'>
										Find expert instructors in medical aesthetics
									</p>
								</CardContent>
							</Card>
						</div>

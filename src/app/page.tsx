...
import { Features, Button } from '@devshop24/component-library';
		...
		<Stack>
			<MainHeader
				...
				subtitle={
					...
					>
						{' '}
						Doctrina LMS is a next-generation education platform and management
						system for medical aesthetic professionals. Designed from the ground
						up to connect educators and students with all the tools needed to
						make the learning experience more efficient and effective.
					</Typography>
				}
				action={

...
console.log(chunkSize)
  ...
  return (
    <Stack sx={{ bgcolor: 'white', p:{xs:2},  overflow: 'hidden', gap:2,  }}>
      <Stack
        sx={{
      ...
      >
        <Typography variant="h2">Trending Courses</Typography>
        <Box mt={2}>
      ...
      <ComponentCarousel slides={slides} sx={{}} chunkSize={chunkSize} animation='fade'/>
